...
namespace PaymentGateway.Api.Specs.Features
{
    ...
    public partial class ProcessPaymentFeature : object, Xunit.IClassFixture<ProcessPaymentFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public ProcessPaymentFeature(ProcessPaymentFeature.FixtureData fixtureData, PaymentGateway_Api_Specs_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "ProcessPayment", "As a merchant, when a shopper buying a product, I process a payment through payme" +
                    "nt gateway", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 6
 testRunner.Given("Shopper provides a bad payment request", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 7
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 14
 testRunner.Given("Shopper provides an invalid credit card", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 15
 testRunner.When("submitting a payment request", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Valid payment request")]
        [Xunit.TraitAttribute("FeatureTitle", "ProcessPayment")]
        [Xunit.TraitAttribute("Description", "Valid payment request")]
        [Xunit.TraitAttribute("Category", "ProcessPayment")]
        public virtual void ValidPaymentRequest()
        {
            string[] tagsOfScenario = new string[] {
                    "ProcessPayment"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                ProcessPaymentFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                ProcessPaymentFeature.FeatureTearDown();
            }
        }
    }
}
